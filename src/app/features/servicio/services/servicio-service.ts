...
export interface ServicioFicha { id: number; numero_orden: number; mesa?: string | null; cliente?: string | null; mesero?: string | null; mesero_id?: number | null; estado?: string; tipo_orden: 'dine-in' | 'to-go' | 'delivery'; tipo_flujo?: 'normal' | 'preorden' | null; hora: string; tiempo_espera_minutos: number; detalles: ServicioDetalle[]; listos: number; total_items: number; todo_listo: boolean; created_at: string; entregada_en?: string | null; fecha_programada?: string | null; estado_preorden?: string | null; preorden_activada_en?: string | null; bloqueada?: boolean; }
